...
function Overview() {
    ...
    return (
        <div className="">
                ...
                {stats.map((stat, index) => (
                    <div key={index} className="bg-white p-6 rounded-xl shadow-sm">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span
                                className={`text-sm ${stat.status === 'increase' ? 'text-green-500' : 'text-gray-500'}`}
                            >
                                {stat.change}
                            </span>
                        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm px-6 pt-4 py-6 h-[360px] w-full flex flex-col">
