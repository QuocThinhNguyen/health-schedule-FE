        ...
        <div className="w-full flex bg-white h-fit">
            ...
            <div className="w-3/5 h-fit bg-black items-center justify-center flex">
                <div className="relative px-40 cursor-pointer" onClick={togglePlay}>
                    <div className="absolute top-0 left-0 z-10 flex items-center justify-between p-4">
                        <button className=" border rounded-full bg-[#3a3a3a] border-none p-1 hover:bg-[#2a2a2a]">
                            <X className="w-6 h-6 font-bold text-white" />
                        </button>
                    </div>
                    <div className="absolute right-0 top-1/3 z-10 flex flex-col gap-2">
                ...
                <div className="p-2">
                    <div className="border border-none bg-[#f8f8f8] rounded-xl p-4 space-y-2">
                        <div className="flex items-center justify-start gap-2">
                            <img src="/mail.png" alt="avatar" className="w-10 h-10 rounded-full" />
                            <div className="w-full">
                                <div className="flex items-center justify-start w-full">
                                    <div className="text-lg font-bold">Bác sĩ Phạm Duy Kiên</div>
                                    <span className="text-sm ml-auto text-blue-700">2025-12-12</span>
                                </div>

                                <div className="items-center justify-start flex gap-2">
                                    <div className="text-sm uppercase">Bệnh viện 115</div>
                                    <div className="text-sm">•</div>
                                    <div className="text-sm uppercase">Chuyên khoa nhi</div>
                                </div>
                            </div>
                        </div>
                        <div className="text-base font-normal">Ho lâu ngày mà không khỏi có thể là nguyên nhân này</div>
                    </div>
                    ...
                    <div className="items-center justify-start flex gap-2 px-4 py-1 w-full bg-[#f1f1f2] rounded-lg">
                        <div className="truncate max-w-80 overflow-hidden text-ellipsis whitespace-nowrap text-sm">
                            https://www.tiktok.com/@duocsidongoc84/video/7328374393619451143?is_from_webapp=1&sender_device=pc&web_id=7269316010044655106
                        </div>
                        <div className="text-sm font-bold ml-auto cursor-pointer">Sao chép liên kết</div>
                    </div>
                    ...
                    {activeTab === 'videos' && <div>video</div>}
                </div>
            </div>
        </div>
    );
